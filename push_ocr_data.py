...
def push_result():
    ...
    try:
        max_id = max(r[0] for r in rows)  # Extract frame_id from tuple
        filtered = [r for r in rows if r[0] % 5 == 0]  # Filter based on frame_id
...
if __name__ == "__main__":
    ...
    scheduler.start()
    print("Uploader started; pushing results every 15 seconds.")  # Corrected time
